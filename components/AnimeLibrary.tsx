...
import { MagnifyingGlassIcon, FilmIcon, TvIcon, CalendarDaysIcon, BarsArrowDownIcon, ChevronDownIcon } from '@heroicons/react/24/solid';
...
<<<<<<< HEAD
=======
            // منع تكرار نفس العنصر في المكتبة
>>>>>>> 3ed2802c93c3d3a58134bc3b4abb9b3e4eff399a
...
=======
    <div className="min-h-screen bg-slate-950 text-slate-200 pt-24 md:pt-28">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        {/* --- رأس الصفحة المحسّن --- */}
        <div className="flex items-center gap-3 mb-8">
            <MagnifyingGlassIcon className="w-10 h-10 text-[color:var(--color-primary)]" />
...
=======
        {/* --- شريط الفلاتر والفرز المحسّن --- */}
        <div className="flex flex-col md:flex-row gap-4 mb-10 items-center justify-between p-4 rounded-xl bg-slate-900/60 border border-slate-800/50">
          {/* أزرار النوع */}
>>>>>>> 3ed2802c93c3d3a58134bc3b4abb9b3e4eff399a
...
=======
          {/* فلاتر السنة والترتيب */}
          <div className="flex items-center gap-4">
            {/* فلتر السنة */}
            <div className="relative">
              <CalendarDaysIcon className="w-5 h-5 text-slate-400 absolute top-1/2 left-3 -translate-y-1/2 pointer-events-none" />
              <select value={selectedYear} onChange={e => setSelectedYear(e.target.value)} className="bg-slate-800 text-slate-200 rounded-full pl-10 pr-4 py-2 appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-500 cursor-pointer">
>>>>>>> 3ed2802c93c3d3a58134bc3b4abb9b3e4eff399a
...
=======
            ...
            <div className="relative">
               <BarsArrowDownIcon className="w-5 h-5 text-slate-400 absolute top-1/2 left-3 -translate-y-1/2 pointer-events-none" />
              <select value={sortOrder} onChange={e => setSortOrder(e.target.value as 'desc' | 'asc')} className="bg-slate-800 text-slate-200 rounded-full pl-10 pr-4 py-2 appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-500 cursor-pointer">
>>>>>>> 3ed2802c93c3d3a58134bc3b4abb9b3e4eff399a
...
<<<<<<< HEAD
=======
        {/* --- شبكة الكاردات و رسالة "لا توجد نتائج" المحسّنة --- */}
>>>>>>> 3ed2802c93c3d3a58134bc3b4abb9b3e4eff399a
